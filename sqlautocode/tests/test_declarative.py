...
metadata = Metadata(bind=create_engine('sqlite:////Users/percious/oss/tgdev/src/sqlautocode/sqlautocode/tests/data/devdata.db'))
...
class TgTown(DeclarativeBase):
    ...
    #relation definitions
    tg_users = relation('TgUser', backref='tg_town')


class TgGroup(DeclarativeBase):
    __table_name__ = 'tg_group'
